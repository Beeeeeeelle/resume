...
<div class="project-case">
  ...
  <div class="project-case__chips">
    ...
    <span class="project-case__chip">DBR cycles</span>
    <span class="project-case__chip">Classroom deployment</span>
  </div>

  <figure class="project-case__hero">
    <img src="/assets/images/projects-petechat-interface-v2.png" alt="PeteChat redesigned interface" />
    <figcaption>PeteChat interface artifact showing the system as a designed learning environment, not only a conceptual AI project.</figcaption>
  </figure>
  ...
  <section class="project-case__section">
    ...
    <ul class="project-case__list">
      <li>Prevent the AI from becoming a shortcut that replaces learning.</li>
      <li>Use guardrails and dialogue structure to support academic integrity and higher-order thinking.</li>
      <li>Refine the system through classroom pilots, stakeholder feedback, and iterative evaluation.</li>
    </ul>
  </section>
